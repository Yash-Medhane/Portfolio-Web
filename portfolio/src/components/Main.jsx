      ...
      <div className="container mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row-reverse justify-around items-center">
        <div className="relative my-image mt-8 md:mt-0">
          <img
            ...
            className="w-96 h-96 md:w-80 md:h-80 rounded-full border-4 border-teal-500 dark:border-coral-400 shadow-lg hover:shadow-2xl transition-shadow duration-300"
            alt="Yash Medhane"
          />
        </div>
        <div className="my-24 intro-container max-w-2xl text-center md:text-left">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-4">
              <span className="text-teal-800 dark:text-coral-400 lg:text-6xl animate-pulse lg:mx-6" style={{fontFamily:'cursive'}}>He/Him</span>
            </h1>
            <h1 className="text-5xl font-bold name text-teal-600 dark:text-coral-300">Yash Medhane</h1>
            <h3 className="text-lg text-gray-600 dark:text-gray-300 font-mono my-4">Web Developer</h3>
          </div>
          ...
          <button
            className="py-3 px-6 text-lg bg-teal-500 text-white dark:bg-coral-400 dark:text-white rounded-lg hover:bg-teal-400 dark:hover:bg-coral-300 transition duration-300"
            onClick={openResume}
          >
            My Resume
          </button>
